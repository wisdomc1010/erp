...
<head>
  ...
  <script type="text/javascript" src="erp_js/inport/inportSlipEdit.js"></script>
	...
	<div class="tools">
		<ul>
			<li><label>&nbsp;&nbsp;供应商名称：&nbsp;&nbsp;</label> 
				...
				<label>&nbsp;&nbsp;单据备注：&nbsp;&nbsp;</label> 
				<input name="mainRemark" id="mainRemark" type="text" class="dfinput" style="width: 190px;" value="${inportSlip.remark }"/>
	        </li>
		</ul>
