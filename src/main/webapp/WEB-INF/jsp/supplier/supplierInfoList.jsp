...
<script type="text/javascript" src="erp_js/supplier/supplierInfoList.js"></script>
...
<div class="tools">
     <ul class="toolbar">
        ...
        <label>&nbsp;&nbsp;联系人：&nbsp;&nbsp;</label>
        <form:input path="contacts" cssClass="dfsearchinput" style="width:120px"/>
        <label>&nbsp;&nbsp;联系电话：&nbsp;&nbsp;</label>
...
<div>
    <ul class="searchtoolbar">
        <li><a href="supplier/supplierInfoAdd"><span><img src="images/t01.png" /></span>添加</a></li>
    ...
    <tbody>
        <c:forEach items="${suppliers}" var="c">
            <tr>
                ...
                <td id="supplierId" style="display: none">${c.id}</td>
                <td width="130px">${c.name}</td>
                <td width="80px">${c.contacts}</td>
                <td width="100px">${c.phone}</td>
                <td width="170px">${c.province}${c.city}${c.address}</td>
    ...
    <ul class="paginList">
        <c:choose>
            <c:when test="${page.page>=page.totalPage && page.totalPage != 1}">
                       <li class="paginItem"><a href="supplier/supplierInfoList/*/*/*/-1/-1/1"><span class="pagepreEndCurrent"></span></a></li>
                   </c:when>
            <c:otherwise>
        ...
        <c:choose>
            <c:when test="${page.page>1}">
                <li class="paginItem"><a href="supplier/supplierInfoList/*/*/*/-1/-1/${page.page-1}"><span class="pagepreCurrent"></span></a></li>
                   </c:when>
            <c:otherwise>
        ...
        <c:forEach var="i" begin="1" end="${page.totalPage}">
            <c:choose>
                <c:when test="${i==page.page}">
                    <li class="paginItem current"><a href="supplier/supplierInfoList/*/*/*/-1/-1/${i}">${i}</a></li>
                </c:when>
                <c:otherwise>
                    <li class="paginItem"><a href="supplier/supplierInfoList/*/*/*/-1/-1/${i}">${i}</a></li>
                </c:otherwise>
            </c:choose>
        </c:forEach>
        ...
        <c:choose>
            <c:when test="${page.page<page.totalPage && page.totalPage!=1}">
                <li class="paginItem"><a href="supplier/supplierInfoList/*/*/*/-1/-1/${page.page+1}"><span class="pagenxtCurrent"></span></a></li>
                   </c:when>
            <c:otherwise>
        ...
        <c:choose>
            <c:when test="${page.page<page.totalPage}">
                <li class="paginItem"><a href="supplier/supplierInfoList/*/*/*/-1/-1/${page.totalPage}"><span class="pagenxtEndCurrent"></span></a></li>
                   </c:when>
            <c:otherwise>
