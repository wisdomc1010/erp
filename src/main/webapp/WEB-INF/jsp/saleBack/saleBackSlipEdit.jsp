...
<head>
	...
	<script type="text/javascript" src="erp_js/saleBack/saleBackSlipEdit.js"></script>
 ...
 <body>
   ...
   <div class="place">
			...
			<li><label>&nbsp;&nbsp;客户名称：&nbsp;&nbsp;</label> 
				<select data-placeholder="请选择客户"  name="customerId" id="customerSelect" class="chosen-select" tabindex="2">
                    ...
                    <c:forEach items="${customer}" var="c">
						<c:choose>
							<c:when test="${c.id==saleBackSlip.customerId}">
				...
				<label>&nbsp;&nbsp;单据备注：&nbsp;&nbsp;</label> 
				<input name="mainRemark" id="mainRemark" type="text" class="dfsearchinput" style="width: 190px;" value="${saleBackSlip.remark }"/>
	        </li>
		</ul>
		<input style="display: none" id="saleBackId" value="${saleBackSlip.id}"></input>
	</div>
	<div>
	...
	<table id="saleBackSlipDetail" class="tablelist" style="width: 65%">
		<thead>
			<tr>
	...
	<div class="saleTip">
		<div class="tiptop">
			<span>退货单明细添加</span><a id="close"></a>
		</div>
		...
		<div class="tipinfo">
	        <div class="formbody">
	            <ul class="forminfo">
	                ...
	                <input name="saleNum" id="saleNum" readonly="readonly" type="text" class="dfinput" style="width: 60px;display: none;border-color: #f00" />
	                </li>
