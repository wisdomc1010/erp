...
<head>
	...
	<script type="text/javascript" src="erp_js/saleBack/saleBackSlipAdd.js"></script>
	...
	<form id="saveDetail">
		<div class="tools">
			<ul>
				...
				<label>&nbsp;&nbsp;单据备注：&nbsp;&nbsp;</label> 
				<input name="mainRemark" id="mainRemark" type="text" class="dfsearchinput" style="width: 190px;" /></li>
			</ul>
		</div>
		<div>
