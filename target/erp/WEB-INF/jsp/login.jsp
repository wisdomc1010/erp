	...
	<div class="loginbody">
		...
		<div class="loginbox">
			...
			<ul>
				...
				<li><input name="pwd" id="pwd" type="text" class="loginpwd"
					value="密码" onclick="JavaScript:this.value=''" /></li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name=""
					type="button" class="loginbtn" value="登录" onclick="doSubmit();" />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input name="" type="button" class="loginbtn" value="重置"
