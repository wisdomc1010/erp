...
<ul class="toolbar">
    		<label>供应商名称：&nbsp;&nbsp;</label><input name="" type="text" class="dfsearchinput" />
				<label>联系人：&nbsp;&nbsp;</label><input name="" type="text" class="dfsearchinput" />
				<label>联系电话：&nbsp;&nbsp;</label><input name="" type="text" class="dfsearchinput" />
				<ul class="searchtoolbar">
         <li class="click"><span><img src="images/t01.png" /></span>添加</li>
       	 <li class="click"><span><img src="images/t02.png" /></span>修改</li>
       	 <li><span><img src="images/t03.png" /></span>停用</li>
       	 <li><span><img src="images/t06.png" /></span>审核</li>
